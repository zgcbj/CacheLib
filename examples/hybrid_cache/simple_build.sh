#!/bin/sh
# Simple build script for hybrid cache example

set -e

echo "Building hybrid-cache-example (simplified)..."

# Check dependencies
HOMEBREW_PREFIX=$(brew --prefix)

# Create a minimal version that compiles with direct includes
cat > minimal_example.cpp << 'EOF'
#include <iostream>
#include <string>
#include <memory>
#include <cassert>
...
g++ -std=c++17 -O2 minimal_example.cpp -o hybrid-cache-example-minimal

echo "Build successful! Run with: ./hybrid-cache-example-minimal"